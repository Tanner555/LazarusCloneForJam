...
namespace LazarusClone
{
    public class ScenarioManager : MonoBehaviour
    {
        ...
        [SerializeField]
        GameObject MyManagersObject;
        [SerializeField]
        GameObject MyCoreCanvas;
        //[SerializeField]
        ...
        {
            MyManagersObject.SetActive(true);
            MyCoreCanvas.SetActive(true);
            ////Activate MainCamera if it's not currently active in scene
            //if (MyMainCamera.activeSelf == false)
